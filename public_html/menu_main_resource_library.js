...
style=menuStyle;
position="relative";
aI("showmenu=drivesystems;url=wizard.php?v=2;image=images/mn_drivesystems1.jpg;overimage=images/mn_drivesystems2.jpg;itemwidth=150;itemheight=26;");
aI("showmenu=resources;url=resource_library.php;image=images/mn_resource_library2.jpg;overimage=images/mn_resource_library2.jpg;itemwidth=148;itemheight=26;");
